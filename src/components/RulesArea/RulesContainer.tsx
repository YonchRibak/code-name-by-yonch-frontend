...
function RulesContainer(): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <div className="mb-8 flex flex-col items-start gap-5">
        <p className="text-2xl ms-8">{t("gameRules.captainsRole.goal")}</p>
        <p className="text-2xl ms-8">{t("gameRules.captainsRole.turn")}</p>
        <p className="text-2xl ms-8">{t("gameRules.captainsRole.example")}</p>
        <p className="text-2xl ms-8">{t("gameRules.captainsRole.number")}</p>
      </div>
      <div className="mb-8 flex flex-col items-start gap-5">
        <h3 className="text-4xl font-semibold mb-8 text-primary">
      ...
      <div className="mb-8 flex flex-col items-start gap-5">
        <p className="text-2xl ms-8">{t("gameRules.captainsRole.violation")}</p>
        <p className="text-2xl ms-8">
